  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      particles.forEach((p, i) => {
        ...
        ctx.fillStyle = `rgba(0, 128, 0, ${p.opacity})`;
        ctx.fill();
        ...
        for (let j = i + 1; j < particles.length; j++) {
          ...
          if (dist < 120) {
            ...
            ctx.strokeStyle = `rgba(0, 128, 0, ${0.08 * (1 - dist / 120)})`;
            ctx.lineWidth = 0.5;
            ctx.stroke();
          }
        }
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden pt-16">
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 80% 60% at 60% 40%, rgba(0,128,0,0.08) 0%, transparent 70%), radial-gradient(ellipse 40% 40% at 80% 80%, rgba(0,128,0,0.05) 0%, transparent 60%)',
        }}
      />
      ...
      <div className="max-w-7xl mx-auto px-6 w-full grid lg:grid-cols-12 gap-8 lg:gap-12 items-center py-20 relative z-10">
        ...
        <div className="lg:col-span-7 space-y-8">
          ...
          <p className="fade-in-up fade-in-up-3 text-lg text-muted-foreground leading-relaxed max-w-lg font-medium">
            Data-driven NEPSE AND GLOBAL MARKET INSIGHTS. Build for serious traders
          </p>
        ...
        <div className="lg:col-span-5 relative fade-in-up fade-in-up-3">
          ...
          <div
            ...
            style={{ background: 'rgba(0,128,0,0.15)' }}
            aria-hidden="true"
          />
        </div>
      </div>
